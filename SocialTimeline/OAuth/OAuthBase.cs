...
namespace SocialTimeline.OAuth
{
    ...
    public class OAuthBase
    {
        ...
        /// </summary>
        /// <param name="para">The query string part of the Url</param>
        /// <returns>A list of QueryParameter each containing the parameter name and value</returns>
        private List<QueryParameter> GetQueryParameters(string para)
        {
            if (para.StartsWith("?"))
            {
        ...
        public string GenerateSignatureBase(Uri url, string consumerKey, string token, string tokenSecret, string httpMethod, string timeStamp, string nonce, string signatureType, out string normalizedUrl, out string normalizedRequestParameters)
        {
            ...
            List<QueryParameter> para = GetQueryParameters(url.Query);
            para.Add(new QueryParameter(OAuthVersionKey, OAuthVersion));
            para.Add(new QueryParameter(OAuthNonceKey, nonce));
            para.Add(new QueryParameter(OAuthTimestampKey, timeStamp));
            para.Add(new QueryParameter(OAuthSignatureMethodKey, signatureType));
            para.Add(new QueryParameter(OAuthConsumerKeyKey, consumerKey));

            if (!string.IsNullOrEmpty(token))
            {
                para.Add(new QueryParameter(OAuthTokenKey, token));
            }

            para.Sort(new QueryParameterComparer());
            ...
            normalizedRequestParameters = NormalizeRequestParameters(para);
